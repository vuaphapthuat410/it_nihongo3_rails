class BookReviewsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @book_review.save
        format.html { redirect_to @book_review.book, notice: 'Book review was successfully created.' } # redirect to book instead book_review
  ...
  def update
    respond_to do |format|
      if @book_review.update(book_review_params)
        format.html { redirect_to @book_review.book, notice: 'Book review was successfully updated.' } # redirect to book instead book_review
  ...
  def destroy
    @book_review.destroy
    respond_to do |format|
      format.html { redirect_to @book_review.book, notice: 'Book review was successfully destroyed.' }
